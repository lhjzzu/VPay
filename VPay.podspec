...
Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.default_subspec = 'Core', 'AliPay', 'UnionPay','WxPay'
  ...
  s.subspec 'Base' do 'base'
    ...
    base.frameworks = 'UIKit','Foudation', 'CoreGraphics','CoreText','QuartzCore','CoreTelephony','SystemConfiguration','CoreMotion','CFNetwork'
    base.library = 'c++', 'stdc++', 'z','libsqlite3.0'
  end
